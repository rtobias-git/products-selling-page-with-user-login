SISTEMA DE GESTÃO DE VENDAS - jpa-introducao

=======================================================
1. CONTEXTO E OBJETIVO
=======================================================

Este projeto foi desenvolvido como um estudo prático focado na integração de tecnologias Java Enterprise (EE), principalmente JSF/Facelets e JPA (Java Persistence API).

O objetivo principal era:
- Demonstrar a persistência de dados complexos, como um Pedido de Venda com múltiplos itens.
- Criar uma interface web funcional para simular o ciclo de vida completo de uma transação de Ponto de Venda (PDV).
...
[Image of user login interface]


3.2. MÓDULO: CRIAÇÃO DE VENDA (Venda)
- Propósito: Montar o pedido (carrinho de compras).
...
3.3. MÓDULO: CONFIRMAÇÃO (Confirmacao da Venda)
...
Para iniciar, compile e faça o deploy do artefato WAR no seu servidor e acesse:
http://localhost:8080/jpa-introducao/login.xhtml
